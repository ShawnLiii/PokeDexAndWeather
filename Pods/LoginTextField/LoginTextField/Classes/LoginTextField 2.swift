...
open class LoginTextField: UITextField {
    ...
    public let seperatorLineView = UIView()
    ...
    fileprivate func setPlaceholder(){
        ...
        attributedPlaceholder = NSAttributedString.init(string: placeholder, attributes: [NSAttributedString.Key.font : font!, NSAttributedString.Key.foregroundColor : placeholderColor])
    }
